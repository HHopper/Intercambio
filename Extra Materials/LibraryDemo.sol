pragma solidity ^0.5.0;
    ...
    /// @dev THIS IS JUST A SIMPLE EXAMPLE OF HOW I COULD USE THE SAFEMATH LIBRARY. SEE LINE 283
    ...
    function transferFunds(bytes32 lesson) public payable checkIfPaused() returns (bool) {
        ...
        uint multiplyStep = SafeMath.mul(tutorAmt, 125);
        uint tutorDeposit = SafeMath.div(multiplyStep, 100);
